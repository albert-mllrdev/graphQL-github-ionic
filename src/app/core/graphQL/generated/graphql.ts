...
export type GetUsersQueryVariables = Exact<{
  ...
  getCreatedDate?: Maybe<Scalars['Boolean']>;
  countFollowers?: Maybe<Scalars['Boolean']>;
  countRepositories?: Maybe<Scalars['Boolean']>;
}>;
...
export type GetUsersFromCacheQuery = (
  { __typename?: 'Query' }
  & { search: (
    { __typename?: 'SearchResultItemConnection' }
    & SearchNodesFragment
...
export type SearchNodesFragment = (
  { __typename?: 'SearchResultItemConnection' }
  & { nodes?: Maybe<Array<Maybe<{ __typename?: 'App' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository' } | (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'login' | 'avatarUrl' | 'viewerIsFollowing' | 'createdAt'>
    & { followers: (
      { __typename?: 'FollowerConnection' }
...
export type FollowUserMutation = (
  ...
  & { followUser?: Maybe<(
    ...
    & { user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'id' | 'viewerIsFollowing'>
      & { followers: (
        { __typename?: 'FollowerConnection' }
        & Pick<FollowerConnection, 'totalCount'>
      ) }
...
export const UserRepositoriesFragmentDoc = gql`
  ...
  pageInfo {
    ...
    `;
export const SearchNodesFragmentDoc = gql`
...
export const GetUsersFromCacheDocument = gql`
  ...
  export class GetUsersFromCacheGQL extends Apollo.Query<GetUsersFromCacheQuery, GetUsersFromCacheQueryVariables> {
    document = GetUsersFromCacheDocument;
